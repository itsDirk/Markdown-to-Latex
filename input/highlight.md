...
Praesentium omnis im==ped==it dolorem alias.
...
## With ==spaces==
==Highlighted text== other text
== Space highlighted text==
==Highlighted text space ==other text
== Space highlighted text space ==
==Highlighted text
second line== other text

==Highlighted text included text 
second line included text
