...
The primary goal of this project is to fully support Markdown written in [Obsidian](https://obsidian.md/) and to closely match its styling in LaTeX. Other Markdown editors are also supported. New features and bugfixes are added whenever possible.
...
- **Align tables** changes how tables are aligned: left/center/right.
- **Align table content** changes how the content inside each cell in a table is aligned: left/center/right.
### Local Installation
